...
export function getCompanies(db) {
  const rows = db.prepare(`
    SELECT c.id, c.slug, c.name, c.region_code, c.data_residency,
      ...
      limits.plan_code, limits.max_vehicles, limits.max_users,
      limits.max_inspections_per_month, limits.max_storage_mb,
      limits.ocr_enabled, limits.ocr_monthly_limit,
      limits.accident_module_enabled, limits.analytics_enabled,
