...
|---|---|---|---|---|---|---|
| 3.1 | `sql.js` → `better-sqlite3` (или внешний RDBMS) | [`sqlite-driver-migration.md`](./sqlite-driver-migration.md) | High | L | M | ✅ закрыт Variant A (2026-06-04) |
| 3.2 | Распределённый rate limit (Redis) | [`rate-limit-redis.md`](./rate-limit-redis.md) | Medium | M | M | ✅ закрыт |
| 3.3 | Декомпозиция `backend/src/server.js` (3 367 строк) | [`server-decomposition.md`](./server-decomposition.md) | Medium | L | M | ✅ закрыт (2026-06-04) |
